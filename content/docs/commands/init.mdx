...
<Callout type="info">
  The default policy is permissive by design. It logs violations as warnings but never blocks.
  Tighten it gradually as you adopt SCAL-P — see [Migration Guide](/docs/guides/migration).
</Callout>
