...
- Only detects _known_ CVEs — no protection against zero-days, protestware, or typosquatting
...
**SCAL-P vs Socket.dev:** They target similar problems from different angles. Socket.dev analyzes _what a package does_ (static analysis). SCAL-P controls _whether a package can be installed_ and _verifies what actually got installed_ (policy + integrity). They complement each other.
