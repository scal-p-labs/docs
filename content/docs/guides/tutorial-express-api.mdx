...
<Callout type="info">
  Committing `.scalp/lockfile.json` gives you a versioned integrity baseline. See [Security Best
  Practices](/docs/guides/security-best-practices) for the tradeoffs.
</Callout>
