...
<Callout type="info">
  Always pin the action to a specific commit SHA instead of a tag. Tags are mutable — a tag could be
  moved to a different commit. SHAs are immutable and guarantee you're running the exact code you
  reviewed.
</Callout>
